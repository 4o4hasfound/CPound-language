...
public:
	...
	virtual void visitPastNode(ASTNode* node) = 0;
	...
	virtual void visitTimelineBeginNode(ASTNode* node) = 0;
	virtual void visitTimelineEndNode(ASTNode* node) = 0;
	virtual void visitTimelineLengthNode(ASTNode* node) = 0;
	virtual void visitTimelinePruneNode(ASTNode* node) = 0;
	virtual void visitTimelineIndexNode(ASTNode*) = 0;
	virtual void visitTimelineInsertNode(ASTNode* node) = 0;
